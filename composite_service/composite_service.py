...
property_service_endpoint = "http://host.docker.internal:8076/property-service/?wsdl"
...
def check_property_evaluation(property_reference, amount):
    ...
    property_evaluation_data = property_evaluation_service_client.service.evaluate_property(property_reference)

    property_evaluation_data = ast.literal_eval(property_evaluation_data)
